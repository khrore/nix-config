...
EOF
  ...
  sudo cp $HOME/.local/share/linux-desktop/default/limine/default.conf /etc/default/limine
  ...
  sudo cp $HOME/.local/share/linux-desktop/default/limine/limine.conf /boot/limine.conf
