...
- prefer composition, interfaces, and discriminated unions over inheritance-heavy reuse
- keep commands and queries separate unless repo conventions explicitly require a stateful API
- use semantic types or validated wrappers when raw primitives create meaningful confusion
- keep expected failures explicit through typed results or documented exception boundaries
- minimize shared mutation with readonly data, pure helpers, and deliberate copies
