...
- for Rust-routed implementation tasks, surface applicable rules from `dotfiles/common/.codex/rules/rust-design-standards.md`
...
- for TypeScript-, Python-, and general-routed implementation tasks, surface applicable rules from `dotfiles/common/.codex/rules/design-standards.md`
...
- `existing_patterns`
- `standards_profile`
- for Rust-routed implementation tasks, `code_map` should include package/crate ownership, crate roots, parent module declarations, and any relevant public API surface that would be affected
